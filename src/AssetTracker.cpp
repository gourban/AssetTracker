...
uint8_t nmea4dot1[] = {0xB5,0x62,0x06,0x17,0x14,0x00,0x00,0x41,0x00,0x02,0x00,0x00,
                       0x00,0x00,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x00,
                       0x00,0x00,0x75,0x57};
uint8_t galileoOn[] = {0xB5,0x62,0x06,0x3E,0x3C,0x00,0x00,0x00,0x20,0x07,0x00,0x08,
                       0x10,0x00,0x01,0x00,0x01,0x01,0x01,0x01,0x03,0x00,0x01,0x00,
                       0x01,0x01,0x02,0x04,0x08,0x00,0x01,0x00,0x01,0x01,0x03,0x08,
                       0x10,0x00,0x00,0x00,0x00,0x01,0x04,0x00,0x08,0x00,0x00,0x00,
                       0x00,0x01,0x05,0x00,0x03,0x00,0x00,0x00,0x00,0x01,0x06,0x08,
                       0x0E,0x00,0x01,0x00,0x01,0x01,0x2C,0x6B};
...
void AssetTracker::gpsOn() {
    ...
    // send command to switch to NMEA 4.1
    for(uint8_t i=0;i<28;i++)
    {
        Serial1.write(nmea4dot1[i]);
    }
    delay(500);

    // send command to turn galileo satellites on
    for(uint8_t i=0;i<68;i++)
    {
        Serial1.write(galileoOn[i]);
    }
    delay(500);
}
